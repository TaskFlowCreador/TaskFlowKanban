      ...
      <div className="board" onPointerMove={onDragMove} onPointerUp={endDrag} onPointerCancel={endDrag}>
        {COLS.map(colId => (
          <div
            ...
            key={colId}
            onAnimationEnd={(e) => { if (e.target === e.currentTarget && e.animationName === 'columnBounce') setDoneBounceId(null); }}
          >
            <div className="column-header"><span>{t[colId]}</span><span className="count-badge" key={board[colId].length}>{board[colId].length}</span></div>
